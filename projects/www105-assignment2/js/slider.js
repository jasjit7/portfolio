...
/* PLUGIN USED for slider
https://www.codehim.com/carousel/jquery-responsive-carousel-slider-with-slideshow-sliderpro/
*/
/*
Modified
*/
...
$(() => {
  ...
  // Slider
  const autoplaySpeed = 2000;//Modified autoplayspeed
  const transitionSpeed = .5;//Transition speed changed 
